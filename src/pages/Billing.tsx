...
type Product = { id:string; name:string; code?:string; barcode?:string; quantity:number; unit:string; selling:number; purchase:number; currency:string; packHierarchyEnabled?:boolean; packHierarchy?:{boxLabel?:string;stripsPerBox?:number;stripLabel?:string;tabletsPerStrip?:number;unitLabel?:string;tabletLabel?:string;stripSelling?:number;tabletSelling?:number} }
